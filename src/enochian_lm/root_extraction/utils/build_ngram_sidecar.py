...
def main() -> None:
    ...
    ap.add_argument("--db", type=Path, default=Path("src/enochian_lm/root_extraction/data/ngram_index.sqlite3"))
    ap.add_argument("--keys", type=Path, default=Path("src/enochian_lm/root_extraction/data/enochian_keys.txt"))
    ap.add_argument("--dict", type=Path, default=Path("src/enochian_lm/root_extraction/data/dictionary.json"))
    ap.add_argument("--subst", type=Path, default=Path("src/enochian_lm/root_extraction/data/substitution_map.json"))
    ap.add_argument("--compress", type=Path, default=Path("src/enochian_lm/root_extraction/data/sequence_compressions.json"))
